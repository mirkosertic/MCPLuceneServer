...
/**
 * Request DTO for the simple search tool (plain text query, special characters treated as literals).
 */
public record SimpleSearchRequest(
        @Nullable
        @Description("Search query (plain text, special characters are treated as literals) or null for match-all")
        String query,
    ...
    /**
     * Create a SimpleSearchRequest from a Map of arguments.
     */
    @SuppressWarnings("unchecked")
    public static SimpleSearchRequest fromMap(final Map<String, Object> args) {
